...
# 🧠 Block-sparse Models in Multi-modality: Application to the Inverse Problem in EEG/MEG (Des Modèles Bloc-parcimonieux en Multi-modalité : Application au Problème Inverse en EEG/MEG)
![EMEG](https://img.shields.io/badge/Modality-EEG%20%7C%20MEG%20%7C%20EMEG-orange.svg)
![method](https://img.shields.io/badge/Domain-Block--sparse_Exact_Recovery_Conditions%20%7C%20Brain_Parcellation-blue.svg)

A comprehensive framework for block-sparse exact recovery conditions in underdetermined systems of linear equations, block structure identification and its application in inverse problem in EEG/MEG/EMEG neuroimaging for automated brain parcellation.

This research work was supported by ERC project [CHESS](https://cordis.europa.eu/project/id/320684) (PI: Prof. [Christian Jutten](https://scholar.google.com/citations?user=iO3qCToAAAAJ&hl=en); Supervisors: Prof. [Ronald Phlypo](https://scholar.google.com/citations?user=hZIeqGMAAAAJ&hl=fr) and Prof. [Christian Jutten](https://scholar.google.com/citations?user=iO3qCToAAAAJ&hl=en)).
