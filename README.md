...
This research work was supported by the ERC project "Challenges in Extraction and Separation of Sources" ([CHESS](https://cordis.europa.eu/project/id/320684)) 
- Supervisors: Prof. [Ronald Phlypo](https://scholar.google.com/citations?user=hZIeqGMAAAAJ&hl=fr) and Prof. [Christian Jutten](https://scholar.google.com/citations?user=iO3qCToAAAAJ&hl=en).
